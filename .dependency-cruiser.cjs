...
module.exports = {
  forbidden: [
    ...
    {
      name: "skill-engine-must-not-depend-on-bootstrap-or-infrastructure",
      severity: "error",
      from: { path: "^services/skill/(src|architecture-fixtures)" },
      to: {
        path: "^(services/bootstrap|apps|packages|infrastructure|infraestructure)/",
      },
    },
    {
      name: "skill-engine-must-not-depend-on-other-engines",
      severity: "error",
      from: { path: "^services/skill/(src|architecture-fixtures)" },
      to: {
        path: "^services/(?!skill(?:/|$)|bootstrap(?:/|$))[^/]+/",
      },
    },
    {
      name: "skill-engine-must-not-depend-on-external-packages",
      severity: "error",
      from: { path: "^services/skill/(src|architecture-fixtures)" },
      to: {
        dependencyTypes: [
    ...
    {
      name: "security-engine-must-not-depend-on-bootstrap-or-infrastructure",
      severity: "error",
      from: { path: "^services/security/(src|architecture-fixtures)" },
      to: {
        path: "^(services/bootstrap|apps|packages|infrastructure|infraestructure)/",
      },
    },
    {
      name: "security-engine-must-not-depend-on-other-engines",
      severity: "error",
      from: { path: "^services/security/(src|architecture-fixtures)" },
      to: {
        path: "^services/(?!security(?:/|$)|bootstrap(?:/|$))[^/]+/",
      },
    },
    {
      name: "security-engine-must-not-depend-on-external-packages",
      severity: "error",
      from: { path: "^services/security/(src|architecture-fixtures)" },
      to: {
        dependencyTypes: [
